...
import {saveCustomer, updateCustomer, uploadCustomerProfileImage, customerProfilePictureUrl} from "../../services/client.js";
...
const MyDropzone = ({ customerId, fetchCustomers }) => {
  const onDrop = useCallback(acceptedFiles => {
    ...
    uploadCustomerProfileImage(
        ...
        errorNotification("Error", "Failed to upload profile image");
    })
    ...
    >
      <input {...getInputProps()} />
      {
        isDragActive ?
          ...
          <p>Drag 'n' drop picture here, or click to select pictures</p>
      }
    </Box>
  )
}
